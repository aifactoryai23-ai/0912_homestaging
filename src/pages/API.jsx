...
export default function APIPage() {
  ...
  return (
    <>
      <Helmet>
        <title>API — HomeDesign Pro</title>
        <meta
          name="description"
          content="Use HomeDesign Pro API to add AI virtual staging and interior redesign to your product. Simple REST endpoints, fast image generation, and secure infrastructure."
        />
        <link rel="canonical" href="https://homedesignpro.ai/api" />
      </Helmet>
