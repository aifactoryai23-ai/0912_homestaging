...
export default function GalleryPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Gallery — AI Virtual Staging Examples | HomeDesign Pro</title>
        <meta
          name="description"
          content="Browse your AI virtual staging projects: before/after images, prompts and downloadable results generated with HomeDesign Pro."
        />
        <link rel="canonical" href="https://homedesignpro.ai/gallery" />
      </Helmet>
      <SignedIn>
